...
slash_commands::slash_commands(dpp::cluster *bot, ::private_vents *private_vents) : bot(bot), private_vents(private_vents) {}
...
void slash_commands::private_dm(dpp::slashcommand_t event)
{
    ...
    private_vents->send_dm(user_id, anon_user_id, message);
